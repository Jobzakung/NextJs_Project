...
const Footer = () => (
    ...
    <footer className="bg-white rounded-lg shadow m-4 dark:bg-gray-800 relative top-[100%] md-phone:top-[43%] lg-phone:top-[50%] md:top-[57%] lg:top-[53%] xl:top-[53%] 2xl:top-[55%]">
